...
class Config:
    ...
    def __init__(self, args):
        ...
        stream_size, batch_size, ipdt, proto_size_t = get_proto_param(args.datatype)
...
def main(args):
    ...
    proto_path = f'./protos_stream/{args.datatype}_ipdt_{config.ipdt}_stream_{config.stream_size}_batch_{config.batch_size}_size_t{config.proto_size_t}'
