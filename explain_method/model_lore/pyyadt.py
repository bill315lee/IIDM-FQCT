...
def fit(df, class_name, columns, features_type, discrete, continuous, filename='yadt_dataset', path='./', sep=';', log=False):
    ...
    retval = os.getcwd()
    # print(retval)
    os.chdir('/home/lb/project/explain_ids/yadt/')
    retval = os.getcwd()
    # print(retval)
    cmd = '/home/lb/project/explain_ids/yadt/dTcmd -fd %s -fm %s -sep %s -d %s' % (data_filename, names_filename, sep, tree_filename)
    output = subprocess.check_output(cmd.split(), stderr=subprocess.STDOUT)
    os.chdir('/home/lb/project/explain_ids/')
    retval = os.getcwd()
    # print(retval)
