from explain_stream.model_deepaid.deepaid import DeepAID
from explain_stream.model_deepaid.autoencoder import train
...
class Model_DeepAID:
    ...
    def fit(self, explain_data, explain_label, explain_idx, proto_path, feature_names):
    ...
    #
    #             explanation_idx_in_attacks.append(i)
    #             label_lst.append(explain_instance_label)
    #
